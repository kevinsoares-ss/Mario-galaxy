Criei a especificação detalhada para a seção de Starfield, integrando perfeitamente os tokens do seu sistema **Super Mario Galaxy** e respeitando as diretrizes de performance e acessibilidade estabelecidas no `DESIGN.md`.
